	...
	return (
		<div id="home" className={styles.container}>
			<Head>
				...
				<meta
					name="description"
					content="SkillEx terms & conditions, privacy policy and code of conduct pertaining to SkillEx"
				/>
			</Head>
			...
			<div id="privacy" className={styles.box}>
				...
				<ul>
					...
					<li>
						<p>
							...
							Company&quot;, &quot;We&quot;, &quot;Us&quot; or
							&quot;Our&quot; in this Agreement) refers to Skillex, 2
							Whitehall Ct, London, SW1A 2EJ.
						</p>
					</li>
					<li>
						<p>
				...
				<ul>
					<li>By mail: 2 Whitehall Ct, London, SW1A 2EJ</li>
				</ul>
			</div>

			<div id="termsOfServices" className={styles.box}>
			...
			<div id="codeOfConduct" className={styles.box}>
				...
				<p>
					...
					religion, or sexual identity and orientation. We pledge to act
					and interact in ways that contribute to an open, welcoming,
				...
				<p>
					...
					constructive feedback Accepting responsibility and apologizing to
					those affected by our mistakes, and learning from the experience
					Focusing on what is best not just for us as individuals, but for
					the overall community Examples of unacceptable behavior include:
					The use of sexualized language or imagery, and sexual attention
					or advances of any kind Trolling, insulting or derogatory
					comments, and personal or political attacks Public or private
					harassment Publishing others' private information, such as a
				...
				<p>
					...
					deem inappropriate, threatening, offensive, or harmful. Community
					leaders have the right and responsibility to remove, edit, or
				...
				<p>
					...
					enforcement at: 2 Whitehall Ct, London, SW1A 2EJ. All complaints
					will be reviewed and investigated promptly and fairly. All
					community leaders are obligated to respect the privacy and
