    ...
    <h1 className={styles.header1}>Terms of Service</h1>
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to Skillex, 2 Whitehall Ct, London, SW1A
              2EJ.
            </p>
          </li>
          <li>
      ...
      <div id="codeOfConduct" className={styles.box}>
        ...
        <p>
          ...
          our community include: Demonstrating empathy and kindness toward other
          ...
          not just for us as individuals, but for the overall community Examples
          of unacceptable behavior include: The use of sexualized language or
          imagery, and sexual attention or advances of any kind Trolling,
        ...
        <p>
          ...
          at: 2 Whitehall Ct, London, SW1A 2EJ. All complaints will be reviewed
          and investigated promptly and fairly. All community leaders are
