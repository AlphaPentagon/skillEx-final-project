					...
					<div className={styles.sectionContainer}>
						...
						<div className={styles.aboutUsContainer}>
							<h3 className={styles.aboutUs}>
								Ever wanted to teach or learn a new Skill, but never
								know where to start?
								<p>
									SkillEx helps you link up with other users that have
									that same burning passion as yourself and allows for
									you to get in contact and organise 1-2-1 lessons.
								</p>
								Browse through our categories, select a skill you would
								like to learn or teach, choose a user that suites you
								and drop them a message.
