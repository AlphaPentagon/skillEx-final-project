  ...
  const text = [
    {
      id: 0,
      value:
        "Fantastic tutors, all willing to help me learn piano within a few months and brushed up on my English teaching skills. Fantastic site!",
    },
    {
      id: 1,
      value:
    ...
    },
    {
      id: 2,
      value:
        " We had one of the tutors assist our son with his French exercise, and it went really well. The tutor was considerate and patient, and he even recommended a free online pronunciation tool that was really helpful",
    },
  ];
